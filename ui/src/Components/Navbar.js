    ...
    return <div>
        <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2 5 dark:bg-gray-900">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                <Link to="/" className="flex self-center text-lg font-semibold whitespace-nowrap dark:text-white">
                    Book Tracker
                </Link>
                ...
                <div class="hidden w-full md:block md:w-auto" id="mobile-menu">
                    <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                        <li>
                            <Link to="/login" class="block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" aria-current="page">Login</Link>
                        </li>
                        <li>
